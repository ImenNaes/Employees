...
namespace Employees.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var employees = db.Employees.Include(e => e.Dep);
        ...
        {
            ViewBag.IdDep = new SelectList(db.Departments, "Id", "Description");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Position,IdDep")] Employee employee)
        {
            ...
            ViewBag.IdDep = new SelectList(db.Departments, "Id", "Description", employee.IdDep);
            return View(employee);
        }
